class DatsunZcarsController < ApplicationController
 ...
 def print_datsun_zcar_pdf
   @datsun_zcar = DatsunZcar.find(params[:id])
   ...
   respond_to do |format|
      ...
      format.pdf do
        ...
        :encoding => 'utf-8',
        :template => 'datsun_zcars/print_datsun_zcar_pdf.pdf.erb',
        :layout => 'pdf.html.erb',
 ...
 def datsun_zcar_params
   params.require(:datsun_zcar).permit(:car_owner_full_name, :car_owner_address, :car_owner_city, :car_owner_state, :car_owner_email, :car_owner_zip, :car_owner_home_phone, :car_owner_work_phone, :car_owner_fax, :car_owner_find_us, :car_owner_home_hours, :car_owner_work_hours, :car_owner_fax_hours, :car_owner_country, :car_owner_where_find_us, :ship_to_full_name, :ship_to_address, :ship_to_city, :ship_to_state, :ship_to_email, :ship_to_zip, :ship_to_phone, :ship_to_fax, :ship_to_contact_person, :ship_to_country, :same_information, :comments, :datsun_type, :vin, :year, :month_built, :year_built, :engine, :rear_axle, :tire_size, :power_steering, :zcar_kit, :tach_calibration, :tach_calibration_without_smog, :ramshorn_w_smog, :ramshorn_w_egr_smog, :driveshaft_except_t400, :driveshaft_t400, :radiator, :electric_fan, :electrolock_t700, :other, :credit_amt, :tach_calibration_amt, :tach_calibration_without_smog_amt, :ramshorn_w_smog_amt, :ramshorn_w_egr_smog_amt, :driveshaft_except_t400_amt, :driveshaft_t400_amt, :radiator_amt, :electric_sfan_amt, :electrolock_t700_amt, :other_amt, :credit_description, :subtotal, :expedite, :sales_tax, :total, :driveshaft_adaptor, :driveshaft_adaptor_amt, :rear_axl_ratio, :trans_type)
 end

 def set_datsun_zcar
    @datsun_zcar = DatsunZcar.find(params[:id])
    @datsun_zcar.set_datsun_zcar
    @datsun_zcar.set_tach_calibration
    @datsun_zcar.set_tach_calibration_without_smog
    @datsun_zcar.set_ramshorn_w_smog
    @datsun_zcar.set_ramshorn_w_egr_smog
    @datsun_zcar.set_driveshaft_except_t400
    @datsun_zcar.set_driveshaft_t400
    @datsun_zcar.set_driveshaft_adaptor
    @datsun_zcar.set_radiator
    @datsun_zcar.set_electric_fan
    @datsun_zcar.set_electrolock_t700
    ...
    @datsun_zcar.car_owner_home_phone
